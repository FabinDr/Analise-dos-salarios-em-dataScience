...
with col_graf4:
    if not df_filtrado.empty:
        ...
        grafico_paises = px.choropleth(media_salarial_por_pais,
...
with st.expander("Tabela com os Dados"):
    ...
    st.dataframe(df_filtrado[showData].head(1000))
    st.caption(f"Mostrando até 1000 de {len(df_filtrado)} registros.")
